...
# repository's main clone. Run them from a worktree: the main clone holds the
# stack's data, and devcontainer-airlock refuses it as a workspace
# (.devcontainer/README.md, "Worktrees only").
